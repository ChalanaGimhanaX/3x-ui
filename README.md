...
```
bash <(curl -Ls https://raw.githubusercontent.com/ChalanaGimhanaX/3x-ui/master/install.sh)
```
...
```
VERSION=v1.7.9 && bash <(curl -Ls "https://raw.githubusercontent.com/ChalanaGimhanaX/3x-ui/$VERSION/install.sh") $VERSION
```
